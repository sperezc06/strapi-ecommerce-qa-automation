...
export async function getServerSideProps() {
  try {
    ...
    if (products) {
      if (products.product_variant && products.product_variant.length > 0) {
    ...
    // Si hay error (por ejemplo, no hay productos), retornar precio 0
    console.error('Error getting highest product price:', error);
    return { props: { highestPrice: 0 } };
  }
}

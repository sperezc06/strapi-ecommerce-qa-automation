...
export interface ApiFeaturedSneakerFeaturedSneaker extends Schema.SingleType {
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    customer_contact: Attribute.Component<'order.order-contact'>;
    products: Attribute.Component<'order.order-products'>;
    shipping_id: Attribute.String;
    rate_id: Attribute.String;
    shipping_name: Attribute.String;
    stripe_id: Attribute.String;
    stripe_url: Attribute.Text;
    stripe_request: Attribute.JSON;
    stripe_response_webhook: Attribute.JSON;
    subtotal: Attribute.Decimal;
    shipping_price: Attribute.Decimal;
    total: Attribute.Decimal;
    payment_status: Attribute.String & Attribute.Required;
    shipping_label: Attribute.JSON;
    tracking_url: Attribute.Text;
    label_image: Attribute.Text;
    tracking_code: Attribute.String;
    order_secret: Attribute.String;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    short_description: Attribute.Text;
    product_variant: Attribute.Component<'product.variant-information', true>;
